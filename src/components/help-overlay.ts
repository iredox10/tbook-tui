        ...
        const sections: { title: string; keys: [string, string][] }[] = [
            {
                ...
                keys: [
                    ...
                    ["f", "Toggle focus mode"],
                    ["m", "Toggle visual minimap"],
                    ["Tab", "Toggle chapter sidebar"],
                    ["T", "Toggle dark / light theme"],
                    ["b", "Add bookmark"],
                    ["B", "View bookmarks"],
                    ["H", "View annotations & highlights"],
                    ["V", "Vocabulary list"],
                    ["t", "Chapter list (TOC)"],
                    ["/", "Search in book"],
            ...
            },
            {
                ...
                keys: [
                    ...
                    ["1 / 2 / 3", "Quick scan Home / Docs / Downloads"],
